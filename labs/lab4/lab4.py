...
def rectangle():
    ...
    area_pt = Point(400 / 2, 400 - 10)
    Area = Text(area_pt, "The Area of the rectangle is: " +str(area))
    perimeter_pt = Point(400 / 2, 400 - 30)
    Perimeter = Text(perimeter_pt, "The Perimeter of the rectangle is: " +str(perimeter))
    Perimeter.draw(win)
    Area.draw(win)
